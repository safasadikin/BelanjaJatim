...
def show_auth_page():
    ...
    try:
        ...
        .login-logo-wrap {{ display:flex; align-items:center; justify-content:center; padding-top:150px; }}
        .login-logo-img {{ width:320px; pointer-events:none; filter:drop-shadow(0 4px 20px rgba(0,0,0,0.5)); }}
        /* Form wrapper */
